 ...
 fn get_bob_account_id() -> AccountId {
    ...
    bob_id
        ...
        async fn default_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
          ...
          /*
            let constructor_psp34 = ContractRef::new();
            let contract_account_id_psp34 = client
		    .instantiate("Contract", &ink_e2e::alice(), constructor_psp34, 0, None)
		    .await
         ...
         */
            ...
            .upload("ContractRef", &ink_e2e::alice(), None)
            .await
         ...
         /*   let alice_id = get_alice_account_id();	 
            let constructor_votantes = VotantesRef::new(alice_id);
            let contract_account_id_votantes = client
		    .instantiate("Voting", &ink_e2e::alice(), constructor_votantes, 0, None)
		     .await
		    .expect("instantiate failed")
		    .account_id;
        */    
            ...
            .upload("VotantesRef", &ink_e2e::alice(), None)
            .await
            .expect("nft contract upload failed")
            .code_hash; 
            ...
            let bob =  get_bob_account_id();
             let change_admin = build_message::<MasterRef>(contract_Master_id.clone())
             .call (|MasterRef| MasterRef.change_admin_with_ref(bob));  
