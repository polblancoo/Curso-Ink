...
pub mod psp34_lop {
    ...
    impl Contract {
        ...
        #[ink(message)]
        pub fn mint_token(&mut self, Voto_de: AccountId) -> Result<(), PSP34Error> {
            psp34::Internal::_mint_to(self, Voto_de, Id::U8(self.next_id))?;
            self.next_id += 1;
            Ok(())
        }          
    }
    impl psp34_lop_organization for Contract  {
        ...
        #[ink(message)]
        fn mint_token_ref(&mut self, Voto_de: AccountId) -> bool{
